function [data exitNow] = sfa_expt4_runBlockTraining(window, param, stim)


%% new measurement (i.e., not restarting) initialize data struct
...
%     blockText = 'Ready for next block.\n\nPress any key to continue.';
        ...
        blockText = ['Ready for next block.\n\n' ...
                     'Remember:\n\n' ...
                     'Key mapping for final tone likelihood rating\n' ...
    ...
    for t = t_start : param.nTrialsPerBlock
        ...
        [data exitNow] = sfa_expt4_runTrialTraining(window, param, stim, trialNum, timingInd, data);
        
        %no save necessary for training
